...
* Load / read data
* Handle weird and missing datas (data processing)
* Illustrate what is in our first dataset by plotting some graphs before searching links with others datasets. (studying our principale data set)
